...
def parseList(y, res, i):
    ...
    if y.group(2) == "":
        ...
        if y.group(2) == "sum":
            ...
            print("\t\t"+ '"'+ y.group(1)+ '"'+ ": " +str(max(numbers)), end="")
        elif y.group(2) == "min":
            ...
            print("\t\t"+ '"'+y.group(1) + '"'+ ": " + + str(min(numbers)), end="")
        elif y.group(2) == "avg":
            ...
            for value in values:
                number = int(value)
                add += number
            print("\t\t"+ '"'+y.group(1)+'"'+ ": " +str(add/len(values)), end="")
        else:
            lst1 = re.sub(r'\(', "[", res[i])
            lst2 = re.sub(r'\)', "]", lst1)
            print("\t\t"+ '"'+ y.group(1) + '"'+ ": " +lst2, end="")
